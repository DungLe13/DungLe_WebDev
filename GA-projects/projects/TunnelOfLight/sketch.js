...
function draw() {
  ...
  for (var i=0; i<agents.length; i++) {
    ...
    if (agents[i].intersectingAgents.length == 3) {
      ...
      strokeWeight(3);
      noFill();
      quad(agents[i].position.x, agents[i].position.y, intersectingAgent1.position.x, intersectingAgent1.position.y, intersectingAgent2.position.x, intersectingAgent2.position.y, intersectingAgent3.position.x, intersectingAgent3.position.y);
    }
